...
- [EE] Enabled Ask Sourcebot to cite user attachments as evidence, rendering the referenced attachment content in the answer and the right-panel evidence view. [#1394](https://github.com/sourcebot-dev/sourcebot/pull/1394)
