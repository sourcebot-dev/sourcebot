...
- [EE] Added Slack-specific copy to the connector OAuth client credentials dialog and made the copy overridable per connector. [#1254](https://github.com/sourcebot-dev/sourcebot/pull/1254)
