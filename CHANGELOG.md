...
- Surfaced an actionable error when the Lighthouse licensing service is unreachable, instead of a generic "unexpected error". [#PR_NUMBER](https://github.com/sourcebot-dev/sourcebot/pull/PR_NUMBER)
