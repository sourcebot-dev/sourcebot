...
- Fixed generic Git URL connection repo names preserving percent-encoded path segments instead of matching decoded remote paths. [#1389](https://github.com/sourcebot-dev/sourcebot/pull/1389)
