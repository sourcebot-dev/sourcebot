...
- Fixed setup-sourcebot local repository mounts failing for host paths with Compose-sensitive characters. [#1390](https://github.com/sourcebot-dev/sourcebot/pull/1390)
