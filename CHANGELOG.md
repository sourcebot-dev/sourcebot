...
- Fixed the Review Agent failing to fetch pull request diffs for private GitHub repositories by fetching diffs through the GitHub Pulls API with the diff accept header instead of the `diff_url`. [#1352](https://github.com/sourcebot-dev/sourcebot/pull/1352)
