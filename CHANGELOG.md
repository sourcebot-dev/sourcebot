...
### Added
- Added Cursor Cloud Agents environment configuration with install/start scripts and cloud agent development skill. [#1671](https://github.com/sourcebot-dev/sourcebot/pull/1671)
