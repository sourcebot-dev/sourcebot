...
# curl/libcurl are pinned to >=8.20.0-r0 to ensure CVE-2026-6276 (cookie leak
# on connection reuse with custom Host headers) is patched. `apk upgrade`
# additionally pulls in the latest patched versions of the other packages.
