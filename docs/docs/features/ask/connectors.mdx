...
Owners can change connector scopes at any time from **Settings → Workspace → Ask Agent** and select **Edit OAuth scopes**.
...
To edit tool permissions, open the connector menu from **Settings → Workspace → Ask Agent** and select **Edit tool permissions**.
