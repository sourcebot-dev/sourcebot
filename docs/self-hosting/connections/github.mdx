...
<AccordionGroup>
    <Accordion title="Index individual repos">
        ```json
        {
            "type": "github",
            "repos": [
    ...
    <Accordion title="Index all repos in a organization">
        ```json
        // Sync all repos in sourcebot-dev, getsentry, and vercel (visible to the provided token, if any)
        {
            "type": "github",
            "orgs": [
                "sourcebot-dev",
    ...
    <Accordion title="Index all repos owned by a user">
        ```json
        {
            "type": "github",
            "orgs": [
    ...
    <Accordion title="Index specific repos">
        ```json
