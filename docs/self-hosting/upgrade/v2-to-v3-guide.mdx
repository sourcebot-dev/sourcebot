...
<Warning>
Please note that the following features are no longer supported in v3. If your deployment is dependent on these features, please [reach out to us](https://github.com/sourcebot-dev/sourcebot/discussions) and we'll prioritize integrating them
back.
