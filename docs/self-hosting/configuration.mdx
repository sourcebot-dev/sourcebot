...
| `SOURCEBOT_AUTH_ENABLED` | `false` | Enables/disables authentication in Sourcebot. If set to `false`, `SOURCEBOT_TENANCY_MODE` must be `single`. See [this doc](/self-hosting/features/authentication) for more info. |
...
<CardGroup cols={2}>
  <Card horizontal title="Authentication" icon="lock" href="/self-hosting/features/authentication" />
  <Card horizontal title="Tenancy" icon="users" href="/self-hosting/features/tenancy" />
  <Card horizontal title="Transactional Emails" icon="envelope" href="/self-hosting/features/transactional-emails" />
  <Card horizontal title="Declarative Configs" icon="page" href="/self-hosting/features/declarative-config" />
</CardGroup>
