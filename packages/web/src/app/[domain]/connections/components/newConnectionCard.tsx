  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 mt-4">
        <Card type="github" title="GitHub" subtitle="Cloud or Enterprise supported." disabled={!isOwner} />
        <Card type="gitlab" title="GitLab" subtitle="Cloud and Self-Hosted supported." disabled={!isOwner} />
        <Card type="gitea" title="Gitea" subtitle="Cloud and Self-Hosted supported." disabled={!isOwner} />
        <Card type="gerrit" title="Gerrit" subtitle="Cloud and Self-Hosted supported." disabled={!isOwner} />
      </div>
      {!isOwner && (
