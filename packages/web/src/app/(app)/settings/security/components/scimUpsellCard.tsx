                ...
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                            <p className="font-medium text-sm">SCIM provisioning is a paid feature</p>
                            <p className="text-xs text-muted-foreground">Upgrade to provision and deprovision members automatically from your identity provider.</p>
                        </div>
                    </div>
