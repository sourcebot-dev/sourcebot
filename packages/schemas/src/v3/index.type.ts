...
export interface SourcebotConfig {
  ...
  settings?: Settings;
  /**
   * [Sourcebot EE] Defines a collection of search contexts. This is only available in single-tenancy mode. See: https://docs.sourcebot.dev/self-hosting/search/search-contexts
   */
  contexts?: {
